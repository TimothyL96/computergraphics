...
using haunter::HauntedHouse;

HauntedHouse myvirtualworld;
...
void myDataInit()
{
 window.title = "TCS2221 Computer Graphics";
 window.posX = 100;
 window.posY = 100;
 window.width  = 800;
 window.height = 500;
...
{
 cout << "*****************************************************************\n";
 cout << "*                   TCS2221 Computer Graphics                   *\n";
 cout << "*                     Trimester 2, 2015/16                     *\n";
 ...
 cout << "|   ENTER                   => trigger Skill : Shadow Ball      |\n";
 cout << "|   ESC                     => exit                             |\n";
 cout << "|                                                               |\n";
